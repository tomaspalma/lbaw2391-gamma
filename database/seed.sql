...
CREATE TRIGGER add_friend
    ...
    INSERT INTO post (author, title, content, attachment, group_id, is_private, date) VALUES
        ...
        (5, 'Diversity in Tech Panel', 'Participated in a panel discussion on promoting diversity in the tech industry.', 'diversity_panel.jpg', 2, false, NOW() - INTERVAL '9 days'),
        (6, 'Environmental Conservation Initiatives', 'Sharing insights into ongoing environmental conservation initiatives and their impact.', null, 3, false, NOW() - INTERVAL '10 days'),
        (7, 'Introduction to Python Programming', 'Started a new series on Python programming for beginners. Excited to help others learn!', null, 4, false, NOW() - INTERVAL '11 days'),
        (8, 'Exploring Ancient Civilizations', 'Delving into the mysteries of ancient civilizations and their contributions to human history.',  'ancient_civilizations.jpg', null, false, NOW() - INTERVAL '12 days'),
        (9, 'Neuroscience Research Breakthrough', 'Sharing recent breakthroughs in neuroscience research and their potential applications.', null, 5, false, NOW() - INTERVAL '13 days'),
        (10, 'Art and Creativity Workshop', 'Organizing a workshop on the intersection of technology and art. Join us for a creative session!', 'art_workshop.jpg', 2, false, NOW() - INTERVAL '14 days'),
        ...
        (13, 'STEM Education Symposium', 'Attended a STEM education symposium discussing ways to enhance science, technology, engineering, and math education.', 'stem_symposium.jpg', null, false, NOW() - INTERVAL '17 days'),
        ...
        (15, 'Business Startups Networking Event', 'Exciting networking event for aspiring entrepreneurs. Share your startup journey and connect with others!', 'startup_event.jpg', 2, false, NOW() - INTERVAL '19 days'),
        ...
        (18, 'Contemporary Art Exhibition', 'Visited a fascinating contemporary art exhibition. Sharing my favorite pieces and interpretations!', 'art_exhibition.jpg', null, false, NOW() - INTERVAL '22 days'),
        ...
        (16, 'Robotics and Automation Showcase', 'Showcasing the latest advancements in robotics and automation. Discussing the future of intelligent machines.', 'robotics_showcase.jpg', null, false, NOW() - INTERVAL '26 days'),
        ...
        (11, 'Marine Ecosystem Conservation', 'Discussing ongoing efforts in marine ecosystem conservation and the importance of protecting our oceans.', 'marine_conservation.jpg', 3, false, NOW() - INTERVAL '29 days'),
        (7, 'Quantum Mechanics Workshop', 'Organizing a workshop on quantum mechanics. Join us for an interactive session on this fascinating topic!', 'quantum_workshop.jpg', 1, false, NOW() - INTERVAL '30 days'),
        ...
        (2, 'Environmental Art Exhibition', 'Visited an art exhibition dedicated to environmental themes. Sharing powerful artworks that convey environmental messages.', 'environmental_art.jpg', null, false, NOW() - INTERVAL '32 days'),
        ...
        (22, 'Future of Electrical Engineering', 'Discussing the future of electrical engineering and emerging technologies in the field.', 'electrical_engineering.jpg', null, false, NOW() - INTERVAL '36 days'),
        ...
        (5, 'Sustainable Energy Solutions Forum', 'Exploring sustainable energy solutions and discussing ways to address climate change through innovative technologies.', 'sustainable_energy_forum.jpg', 4, false, NOW() - INTERVAL '39 days');
