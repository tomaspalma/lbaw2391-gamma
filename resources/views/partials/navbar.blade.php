...
<nav class="bg-white border-black border-b @if(!isset($no_margin)) mb-5 @endif p-4 shadow-lg">
    <div class="max-w-screen-xl flex flex-col lg:flex-row justify-around mx-auto">
        ...
        <div class="items-center lg:flex lg:w-1/3 lg:justify-end">
            <i id="hamburger-toggle" class="lg:hidden block fa-solid fa-bars mt-4 cursor-pointer"></i>
            <ul id="navbar-menu" class="hidden lg:flex flex flex-col justify-center align-middle items-center p-4 lg:p-0 mt-4 font-medium bg-gray-50 lg:flex-row lg:space-x-2 lg:mt-0 lg:border-0 lg:bg-white">
                ...
                <li>
                    <a href="/users/{{Auth::user()->username}}/friends" class="block py-2 pl-3 pr-4">
                        <div class="relative flex flex-row lg:flex-col space-x-1 lg:space-x-0">
                            <i class="fa-solid fa-user-group text-2xl max-lg:hidden"></i>
                            <span class="lg:hidden">Friends</span>
                            <span id="friend-request-counter" class="{{count(Auth::user()->received_pending_friend_requests()->get()) > 0 ? '' : 'hidden'}} text-xs lg:absolute lg:bottom-3 lg:left-3 bg-red-500 text-white w-5 h-5 flex items-center justify-center rounded-full">
                ...
                <li>
                    <a href="/groups" class="block py-2 pl-3 pr-4">
                        <div class="relative flex flex-row lg:flex-col space-x-1 lg:space-x-0">
                            <i class="fa-solid fa-people-group text-2xl max-lg:hidden"></i>
                            <span class="lg:hidden">Groups</span>
                            <span id="group-request-counter" class="{{count(Auth::user()->groupRequests()) > 0 ? '' : 'hidden'}} text-xs lg:absolute lg:bottom-3 lg:left-3 bg-red-500 text-white w-5 h-5 flex items-center justify-center rounded-full">
                ...
                <li class="flex items-center space-x-0">
                    <a href="/users/{{Auth::user()->username}}" class="relative flex flex-row lg:flex-col space-x-1 lg:space-x-0">
                        <img src="{{ Auth::user()->getProfileImage('small') }}" class="rounded-full w-10 h-10 max-lg:hidden" alt="{{ Auth::user()->username }}'s Profile Image">
                ...
                <li>
                    <form id="logout-action" method="POST" action="{{ route('logout') }}" class="block py-2 pl-3 pr-4 mb-0">
                        ...
                        <button type="submit" class="hover:underline">
                            <i class="fa-solid fa-arrow-right-from-bracket text-2xl max-lg:hidden"></i>
